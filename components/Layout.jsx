...
const sidebarNavigation = [
  ...
  { name: 'Projects', href: '/projects', icon: Squares2X2Icon, current: false },
  { name: 'Users', href: '/users', icon: PhotoIcon, current: true },
  { name: 'Pipeline', href: '/pipeline', icon: UserGroupIcon, current: false },
  { name: 'About Us', href: '#', icon: RectangleStackIcon, current: false },
